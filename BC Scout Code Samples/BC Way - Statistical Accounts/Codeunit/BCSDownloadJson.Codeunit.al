codeunit 50704 "BCS Download Json"
{
    ...
    // and I hope he continues contributing to our BC community.
    // https://github.com/ivanrlg
    // https://github.com/ivanrlg/GenericJson
    trigger OnRun()
    begin
    end;
    ...
    var
        BCSRecJSONManagement: Codeunit "BCS Rec JSON  Management";
    ...
    begin
        ...
        if RecordRef.FindSet() then
            repeat
                ...
                mJsonArray.Add(BCSRecJSONManagement.RecordToJson(RecordRef));
